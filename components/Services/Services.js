        ...
        <section className='p-5'>
            ...
            <div className='flex justify-between items-start flex-wrap max-sm:justify-center max-sm:items-start'>
                ...
                <div style={{ margin: 'auto' }} className='flex justify-between flex-col items-start'>
                    <span className='mt-10 mb-10 text-4xl cursor-scale small' >Here’s what you can <br /> expect from me...</span>
                    ...
                    <Link href={'/#Contact'}>
                        <Button className="text-lg flex gap-2 mt-5 cursor-scale small">Work with me <ArrowRight /> </Button>
                    </Link>
                </div>
